...
<%--                                    <button type="button" class="btn btn-outline-warning" style="margin-left: 30%">რედაქტირება</button>--%>
                                    <button style="margin-left: 70%" type="button" class="btn btn-outline-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
